...
pub fn unreliable_sequenced_cyphertext_ping_pong(ordering: Ordering) -> TestTree {
    group!(
        format!("Unit tests, ordering with {:?}", ordering),
        ordering,
        [
            setting!(Timeout(Duration::from_secs(5))),
            single!(|| { unreliable_sequenced_cyphertext_ping_pong_corrupt_immune() }),
            single!(|| { unreliable_sequenced_cyphertext_ping_pong_corrupt_integrity() }),
            single!(|| { unreliable_sequenced_cyphertext_ping_pong_corrupt_order() }),
            single!(|| { unreliable_sequenced_cyphertext_ping_pong_corrupt_presence() }),
        ]
    )
}
pub fn unreliable_sequenced_cyphertext_ping_pong_corrupt_immune() -> Result<()> {
    ...
    let address4 = ReplyTo::UdpIpV4("127.0.0.1:50025".parse()?);
    let address5 = ReplyTo::UdpIpV4("127.0.0.1:50026".parse()?);
    ...
    let response = std::thread::spawn(move || {
        let data: String = echo_protocol1.unreliable_sequenced_cyphertext_ping(echo_protocol_sid0.public_id()).unwrap();
...
pub fn unreliable_sequenced_cyphertext_ping_pong_corrupt_integrity() -> Result<()> {
    let router_0 = "router_0";
    let router_1 = "router_1";
    let echo_protocol_0 = "echo_protocol_0";
    let echo_protocol_1 = "echo_protocol_1";
    ...
    let link_sid4 = PrivateIdentityInterface::new_key();
    let link_sid5 = PrivateIdentityInterface::new_key();
    let address4 = ReplyTo::UdpIpV4("127.0.0.1:50027".parse()?);
    let address5 = ReplyTo::UdpIpV4("127.0.0.1:50028".parse()?);
    let link_id4 = LinkId::link_with_type(link_sid4.clone(), PublicIdentityInterface::new(link_sid5.public_id()), address4.clone());
    let link_id5 = LinkId::link_with_type(link_sid5.clone(), PublicIdentityInterface::new(link_sid4.public_id()), address5.clone());
    let mut link4: UdpIpV4 = Link::new(link_id4.clone(), actual_behaviour.label(link_4.clone()), broker1.peer_with_link(link_id4.remote(address5)?)?)?;
    let mut link5: UdpIpV4 = Link::new(link_id5.clone(), actual_behaviour.label(link_5.clone()), echo_protocol1.peer_with_link(link_id5.remote(address4)?)?)?;
    ...
    process_network(expected_behaviour, receiver)?;
    let actual_response = response.join().expect("failed to extract data from JoinHandle");
    let expected_response = "pngpong".to_string();
    if actual_response != expected_response{
        Err(anyhow!("actual returned data (1st under) didn't match expected returned data (2nd under):\n{}\n{}", actual_response, expected_response))
    } else {
        Ok(())
...
pub fn unreliable_sequenced_cyphertext_ping_pong_corrupt_order() -> Result<()> {
    let router_0 = "router_0";
    let router_1 = "router_1";
    let echo_protocol_0 = "echo_protocol_0";
    let echo_protocol_1 = "echo_protocol_1";
    ...
    let link_sid4 = PrivateIdentityInterface::new_key();
    let link_sid5 = PrivateIdentityInterface::new_key();
    let address4 = ReplyTo::UdpIpV4("127.0.0.1:50029".parse()?);
    let address5 = ReplyTo::UdpIpV4("127.0.0.1:50030".parse()?);
    let link_id4 = LinkId::link_with_type(link_sid4.clone(), PublicIdentityInterface::new(link_sid5.public_id()), address4.clone());
    let link_id5 = LinkId::link_with_type(link_sid5.clone(), PublicIdentityInterface::new(link_sid4.public_id()), address5.clone());
    let mut link4: UdpIpV4 = Link::new(link_id4.clone(), actual_behaviour.label(link_4.clone()), broker1.peer_with_link(link_id4.remote(address5)?)?)?;
    let mut link5: UdpIpV4 = Link::new(link_id5.clone(), actual_behaviour.label(link_5.clone()), echo_protocol1.peer_with_link(link_id5.remote(address4)?)?)?;
...
pub fn unreliable_sequenced_cyphertext_ping_pong_corrupt_presence() -> Result<()> {
    let router_0 = "router_0";
    let router_1 = "router_1";
    let echo_protocol_0 = "echo_protocol_0";
    let echo_protocol_1 = "echo_protocol_1";
    ...
    let link_sid4 = PrivateIdentityInterface::new_key();
    let link_sid5 = PrivateIdentityInterface::new_key();
    let address4 = ReplyTo::UdpIpV4("127.0.0.1:50031".parse()?);
    let address5 = ReplyTo::UdpIpV4("127.0.0.1:50032".parse()?);
    let link_id4 = LinkId::link_with_type(link_sid4.clone(), PublicIdentityInterface::new(link_sid5.public_id()), address4.clone());
    let link_id5 = LinkId::link_with_type(link_sid5.clone(), PublicIdentityInterface::new(link_sid4.public_id()), address5.clone());
    let mut link4: UdpIpV4 = Link::new(link_id4.clone(), actual_behaviour.label(link_4.clone()), broker1.peer_with_link(link_id4.remote(address5)?)?)?;
    let mut link5: UdpIpV4 = Link::new(link_id5.clone(), actual_behaviour.label(link_5.clone()), echo_protocol1.peer_with_link(link_id5.remote(address4)?)?)?;
